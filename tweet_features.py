...
testFeatures = \
    [('hasAddict',     (' addict',)), \
     ('hasAwesome',    ('awesome',)), \
     ('hasBernie',     ('bern','bernie', 'sanders', 'sandman')), \
     ('hasBroken',     ('broke',)), \
     ('hasBad',        (' bad',)), \
     ('hasRacist',     (' racism', 'racist')), \
     ('hasBug',        (' bug',)), \
     ('hasCruz',       ('ted','cruz')), \
     ('hasCant',       ('cant','can\'t')), \
     ('hasClinton',      ('clinton', 'hilary')), \
     ('hasCrash',      ('crash',)), \
     ('hasCool',       ('cool',)), \
     ...
     ('hasLol',        (' lol',)), \
     ('hasLove',       ('love','loving')), \
     ('hasLose',       (' lose', 'losing', 'lost')), \
     ('hasNeat',       ('neat',)), \
     ('hasNeg',      (' insufferable', 'deplete', 'exhaust', 'detest', 'obscure', 'stigma', 'buzz', 'hysteria', 'wicked', 'criminal')), \
     ('hasNever',      (' never',)), \
     ('hasNice',       (' nice',)), \
     ('hasPos',       ('honor', 'amazing', 'best', 'uplift', 'lawful', 'sincere', 'truthful')), \
     ('hasPoor',       ('poor',)), \
     ('hasPerfect',    ('perfect',)), \
     ('hasPlease',     ('please',)), \
     ('hasRubio',    ('rubio' ,'marco')), \
     ('hasSerious',    ('serious',)), \
     ('hasShit',       ('shit',)), \
     ('hasSlow',       (' slow',)), \
     ('hasSmiley',     (':)', ':D', '(:')), \
     ('hasSuck',       ('suck',)), \
     ('hasTrump',    ('donald' ,'trump')), \
