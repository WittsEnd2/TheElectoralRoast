  ...
  body
    ...
    .container
      .row
        .col-md-12
          .header
            h1.headline.text-center Donald Trump Campaign Map
      .row
        .col-md-12
          p.bodyText.text-center Twitter posts from potential voters about Donald Trump
