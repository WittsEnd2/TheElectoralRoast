...
html
  ...
  body
    ...
    script(src="/jqeury-jvectormap-2.0.3.min.js")
    ...
    .container
      .row
        .col-md-12
          .header
            h1.headline.text-center Political Tracker
      .row
        .col-md-12
          p.bodyText This is where the description would go.
      br
      br
    ...
    //
      script.
        ...
        var node = fBase.child("Tweets/Bernie");
        var flag = false;
        var information = {};
        var map;
        function initMap() {
